...
public class GoogleDriveService {
    ...
    public static String uploadFile(java.io.File file, String remoteFileName, String mimeType) throws Exception {
        ...
        // fileMetadata.setParents(Collections.singletonList("folderId")); // Opcional:
        // si se necesita un folder específico
    ...
    public static OutputStream downloadFile(String fileId) throws Exception {
        Drive service = getDriveService();
